...
namespace DSharpDXRastertek.TutTerr19.Graphics
{
    public class DDX11                  // 416 lines
    {
        // Properties.
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
                ...
                secBlendStateDesc.AlphaToCoverageEnable = true;
                secBlendStateDesc.RenderTarget[0].IsBlendEnabled = true;
                secBlendStateDesc.RenderTarget[0].SourceBlend = BlendOption.One;
                secBlendStateDesc.RenderTarget[0].DestinationBlend = BlendOption.InverseSourceAlpha;
