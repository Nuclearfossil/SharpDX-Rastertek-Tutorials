...
namespace DSharpDXRastertek.TutTerr19.Graphics.Data
{
    public class DUserInterface                 // 219 lines
    {
        // properties
        ...
        public bool Frame(int fps, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, DeviceContext deviceContext)
        {
        ...
        public void Render(DDX11 D3DDevice, DShaderManager shaderManager, Matrix worldMatrix, Matrix viewMatrix, Matrix orthoMatrix)
        {
            ...
            FpsString.Render(D3DDevice.DeviceContext, shaderManager, worldMatrix, viewMatrix, orthoMatrix, Font1.Texture.TextureResource);

            // Render the position and rotation strings.
            foreach (DText position in PositionStrings)
                position.Render(D3DDevice.DeviceContext, shaderManager, worldMatrix, viewMatrix, orthoMatrix, Font1.Texture.TextureResource);

            // Render the video card strings.
            foreach (DText vidString in VideoStrings)
                vidString.Render(D3DDevice.DeviceContext, shaderManager, worldMatrix, viewMatrix, orthoMatrix, Font1.Texture.TextureResource);
