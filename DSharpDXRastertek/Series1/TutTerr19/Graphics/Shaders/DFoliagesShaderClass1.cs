...
{
    public class DFoliagesShader                    // 263 lines
    {
        // Structures
        ...
        public bool Initialize(Device device, IntPtr windowHandler)
        {
            ...
            return InitializeShader(device, windowHandler, "foliage.vs", "foliage.ps");
        }
        private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                ShaderBytecode vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "FoliageVertexShader", DSystemConfiguration.VertexShaderProfile, ShaderFlags.None, EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "FoliagePixelShader", DSystemConfiguration.PixelShaderProfile, ShaderFlags.None, EffectFlags.None);
