...
namespace DSharpDXRastertek.Tut27.Graphics.Shaders
{
    public class DReflectionShader                  // 281 lines
    {
        // Structs
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct DReflectionBuffer
        {
            public Matrix reflection;
        }

        // Properties
        // Added 'ConstantReflectionBuffer' property in Tutorial 27 for implementing Reflections.
        public VertexShader VertexShader { get; set; }
        public PixelShader PixelShader { get; set; }
        public InputLayout Layout { get; set; }
        public SharpDX.Direct3D11.Buffer ConstantMatrixBuffer { get; set; }
        public SharpDX.Direct3D11.Buffer ConstantReflectionBuffer { get; set; }
        public SamplerState SamplerState { get; set; }

        // Constructor
        public DReflectionShader() { }

        // Methods
        public bool Initialize(Device device, IntPtr windowsHandler)
        {
            // Initialize the vertex and pixel shaders.
            return InitializeShader(device, windowsHandler, "Reflection.vs", "Reflection.ps");
        }
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                ShaderBytecode vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "ReflectionVertexShader", DSystemConfiguration.VertexShaderProfile, ShaderFlags.None, EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "ReflectionPixelShader", DSystemConfiguration.PixelShaderProfile, ShaderFlags.None, EffectFlags.None);
                ...
                BufferDescription reflectionBufferDesc = new BufferDescription()
                {
                    Usage = ResourceUsage.Dynamic,
                    SizeInBytes = Utilities.SizeOf<DReflectionBuffer>(),
                    BindFlags = BindFlags.ConstantBuffer,
                    CpuAccessFlags = CpuAccessFlags.Write,
                    OptionFlags = ResourceOptionFlags.None,
                    StructureByteStride = 0
                ...
                // Create the constant buffer pointer so we can access the vertex shader constant buffer from within this class.
                ConstantReflectionBuffer = new SharpDX.Direct3D11.Buffer(device, reflectionBufferDesc);
                #endregion
