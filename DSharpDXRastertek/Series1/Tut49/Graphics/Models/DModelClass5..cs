...
namespace DSharpDXRastertek.Tut49.Graphics.Models
{
    public class DModel                 // 202 lines
    {
        ...
        // Methods
        public bool Initialize(SharpDX.Direct3D11.Device device, string modelFormatFilename, string textureFileNames, float scale)
        {
        ...
        private bool InitializeBuffers(SharpDX.Direct3D11.Device device, float scale)
        {
            try
            {
