using DSharpDXRastertek.Tut34.Graphics.Data;
...
namespace DSharpDXRastertek.Tut34.Graphics.Models
{
    public class DModel                 // 194 lines
    {
        // Structures
        ...
        {
            return TextureCollection.TextureList[0].TextureResource;
        }
