using DSharpDXRastertek.Tut34.Graphics;
using DSharpDXRastertek.Tut34.Input;
using SharpDX.Windows;
using System.Drawing;
using System.Windows.Forms;
using TestConsole;

namespace DSharpDXRastertek.Tut34.System
{
    public class DSystem                    // 157 lines
    {
        // Properties
        ...
        public virtual bool Initialize(string title, int width, int height, bool vSync, bool fullScreen, int testTimeSeconds)
        {
            ...
            Position.SetPosition(0.0f, 1.5f, -7.0f);
