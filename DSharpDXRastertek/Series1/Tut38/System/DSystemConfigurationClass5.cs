...
namespace DSharpDXRastertek.Tut38.System
{
    public class DSystemConfiguration                   // 55 lines
    {
        ...
        public static string DomainShaderProfile = "ds_5_0";
        ...
        public static string HullShaderProfile = "hs_5_0";
        ...
        static DSystemConfiguration()
        {
            ...
            ShaderFilePath = @"Series1\Tut38\Externals\Shaders\";
        }
    }
}