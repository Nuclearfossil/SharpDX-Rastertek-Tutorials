using DSharpDXRastertek.TutTerr06.Graphics;
using DSharpDXRastertek.TutTerr06.Graphics.Camera;
using DSharpDXRastertek.TutTerr06.Graphics.Data;
using DSharpDXRastertek.TutTerr06.Graphics.Input;
using DSharpDXRastertek.TutTerr06.Graphics.Models;
using DSharpDXRastertek.TutTerr06.Graphics.Shaders;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.TutTerr06.System
{
    public class DApplication                   // 292 lines
    {
        // Properties
        ...
        public DQuadTree QuadTree { get; set; }
        public DFrustum Frustum { get; set; }
        #endregion

        #region Shaders  
        public DTerrainShader TerrainShader { get; set; } // DTerrainShader
        #endregion     
        ...
        private bool RenderGraphics()
        {
            ...
            // Render the text user interface elements.FontShader
