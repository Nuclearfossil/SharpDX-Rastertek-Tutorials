...
namespace DSharpDXRastertek.Tut48.Graphics.Shaders
{
    public class DShadowShader                  // 301 lines
    {
        // Structs
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Matrix lightViewMatrix, Matrix lightProjectionMatrix, ShaderResourceView texture, ShaderResourceView depthMapTexture, Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, lightViewMatrix, lightProjectionMatrix, texture, depthMapTexture, lightDirection, ambientColor, diffuseColor))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Matrix lightViewMatrix, Matrix lightProjectionMatrix, ShaderResourceView texture, ShaderResourceView depthMapTexture, Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor) 
        {
            try
            {
