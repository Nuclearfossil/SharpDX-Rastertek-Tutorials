using DSharpDXRastertek.Tut15.Graphics.Shaders;
using DSharpDXRastertek.Tut15.System;
using SharpDX;
...
namespace DSharpDXRastertek.Tut15.Graphics.Data
{
    public class DFont                  // 178 lines
    {
        // Structs
        ...
        public void BuildVertexArray(out List<DFont.DVertex> vertices, string sentence, float drawX, float drawY)
        {
            // Create list of the vertices
            vertices = new List<DFont.DVertex>();
        ...
        private void BuildVertexArray(List<DFont.DVertex> vertices, int letter, ref float drawX, ref float drawY)
        {
