...
{
    public class DTerrain                   // 552 lines
    {
        // Structs
        ...
        public DTexture DetailTexture { get; set; }

        // Constructor
        public DTerrain() { }

        // Methods.
        public bool Initialize(SharpDX.Direct3D11.Device device, string heightMapFileName, string textureFileName, string colorMapFilename, string detailMapFilename)
        {
