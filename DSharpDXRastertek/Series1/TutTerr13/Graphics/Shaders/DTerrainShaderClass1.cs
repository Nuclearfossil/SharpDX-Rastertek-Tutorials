using DSharpDXRastertek.TutTerr13.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr13.Graphics.Shaders
{
    public class DTerrainShader                 // 285 lines
    {
        // Structures
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection, ShaderResourceView texture, ShaderResourceView detailTexture)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, ambientColour, diffuseColour, lightDirection, texture, detailTexture))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection, ShaderResourceView texture, ShaderResourceView detailTexture)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResource(1, detailTexture);
