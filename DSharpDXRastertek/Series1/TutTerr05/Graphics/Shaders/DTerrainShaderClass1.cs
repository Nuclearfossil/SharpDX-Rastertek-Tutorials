using DSharpDXRastertek.TutTerr05.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr05.Graphics.Shaders
{
    public class DTerrainShader                 // 264 lines
    {
        // Structures
        ...
        public bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection, ShaderResourceView texture)
        {
            try
            {
