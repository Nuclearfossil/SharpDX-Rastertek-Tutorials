using DSharpDXRastertek.TutTerr02.Graphics;
using DSharpDXRastertek.TutTerr02.Graphics.Camera;
using DSharpDXRastertek.TutTerr02.Graphics.Input;
using DSharpDXRastertek.TutTerr02.Graphics.Models;
...
namespace DSharpDXRastertek.TutTerr02.System
{
    public class DApplication                   // 259 lines
    {
        ...
        #region Models
        public DTerrainHeightMap Terrain { get; set; }
        #endregion
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
                ...
                Camera.SetPosition(57.0f, 2.0f, -7.0f);

                // Create the model object.
                Terrain = new DTerrainHeightMap();

                // Initialize the terrain object.
                if (!Terrain.Initialize(D3D.Device, "heightmap01.bmp"))
                    return false;
