using DSharpDXRastertek.TutTerr09.Graphics;
using DSharpDXRastertek.TutTerr09.Graphics.Camera;
using DSharpDXRastertek.TutTerr09.Graphics.Data;
using DSharpDXRastertek.TutTerr09.Graphics.Input;
using DSharpDXRastertek.TutTerr09.Graphics.Models;
...
{
    public class DApplication                   // 259 lines
    {
        // Properties
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
                ...
                Camera.SetPosition(32.0f, 1.0f, 63.0f);
               ...
               // Initialize the terrain object.
                if (!TerrainModel.Initialize(D3D.Device, "heightmap02.bmp", "legend.txt", "materialmap01.bmp", "colorm02.bmp"))
                    return false;
        ...
        public bool Frame(float frameTime)
        {
            ...
            if (!Text.SetCpu(CPU.CPUUsage, CPU.CPUUsage0, D3D.DeviceContext))
                return false;
        ...
        private bool RenderGraphics()
        {
            ...
            if (!TerrainModel.Render(D3D.DeviceContext, TerrainShader, worldMatrix, cameraViewMatrix, projectionMatrix, Light.AmbientColor, Light.DiffuseColour, Light.Direction))
                return false;
