using DSharpDXRastertek.TutTerr03.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr03.Graphics.Shaders
{
    public class DTerrainShader                 // 262 lines
    {
        // Structures
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, ambientColour, diffuseColour, lightDirection))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection)
        {
            try
            {
