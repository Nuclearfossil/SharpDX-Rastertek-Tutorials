using DSharpDXRastertek.TutTerr03.Graphics;
using DSharpDXRastertek.TutTerr03.Graphics.Camera;
using DSharpDXRastertek.TutTerr03.Graphics.Data;
using DSharpDXRastertek.TutTerr03.Graphics.Input;
using DSharpDXRastertek.TutTerr03.Graphics.Models;
using DSharpDXRastertek.TutTerr03.Graphics.Shaders;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.TutTerr03.System
{
    public class DApplication                   // 271 lines
    {
        // Properties
        ...
        private bool RenderGraphics()
        {
            ...
            if (!TerrainShader.Render(D3D.DeviceContext, TerrainModel.IndexCount, worldMatrix, cameraViewMatrix, projectionMatrix, Light.AmbientColor, Light.DiffuseColour, Light.Direction))
                return false;
