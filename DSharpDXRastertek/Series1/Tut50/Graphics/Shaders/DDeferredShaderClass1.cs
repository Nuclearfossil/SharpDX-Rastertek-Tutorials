...
{
    public class DDeferredShader                    // 225 lines
    {
        // Structures
        ...
        public SamplerState SampleStateWrap { get; set; }

        // Methods
        public bool Initialize(Device device, IntPtr windowHandler)
        {
            // Initialize the vertex and pixel shaders.
            return InitializeShader(device, windowHandler, "deferred.vs", "deferred.ps");
        }
        private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                ShaderBytecode vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "DeferredVertexShader", "vs_4_0", ShaderFlags.None, EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "DeferredPixelShader", "ps_4_0", ShaderFlags.None, EffectFlags.None);
                ...
                SampleStateWrap = new SamplerState(device, samplerDesc);
        ...
        private void RenderShader(DeviceContext deviceContext, int indexCount)
        {
            ...
            deviceContext.PixelShader.SetSampler(0, SampleStateWrap);
