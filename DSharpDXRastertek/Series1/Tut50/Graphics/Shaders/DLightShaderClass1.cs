...
{
    public class DLightShader                   // 260 lines
    {
        // Structures
        ...
        public SamplerState SampleStateClamp { get; set; }
        ...
        private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                SampleStateClamp = new SamplerState(device, samplerDesc);
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView colorTexture, ShaderResourceView normalTexture, Vector3 lightDirection)
        {
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView colorTexture, ShaderResourceView normalTexture, Vector3 lightDirection)
        {
            try
            {
        ...
        private void RenderShader(DeviceContext deviceContext, int indexCount)
        {
            ...
            deviceContext.PixelShader.SetSampler(0, SampleStateClamp);
