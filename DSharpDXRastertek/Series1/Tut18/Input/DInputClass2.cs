...
namespace DSharpDXRastertek.Tut18.Input
{
    public class DInput                 // 206 lines
    {
        // Variables .
        ...
        private bool ReadKeyboard()
        {
            ...
            // Error usually occurs when mouse pointer is off the window and pressed. Short circuit re aquisition of the mouse when the Mouse cursor if off the Windows.
