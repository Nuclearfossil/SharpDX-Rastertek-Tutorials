using DSharpDXRastertek.TutTerr01.Graphics.Data;
...
namespace DSharpDXRastertek.TutTerr01.Graphics.Models
{
    public class DText                  // 321 lines
    {
        // Structs
        ...
        public DSentence[] sentences = new DSentence[6];
