using DSharpDXRastertek.TutTerr08.Graphics;
using DSharpDXRastertek.TutTerr08.Graphics.Camera;
using DSharpDXRastertek.TutTerr08.Graphics.Data;
using DSharpDXRastertek.TutTerr08.Graphics.Input;
using DSharpDXRastertek.TutTerr08.Graphics.Models;
using DSharpDXRastertek.TutTerr08.Graphics.Shaders;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.TutTerr08.System
{
    public class DApplication                   // 291 lines
    {
        // Properties
        ...
        public DMiniMapClass MiniMap { get; set; }
        #endregion     
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
                ...
                if (!TerrainModel.Initialize(D3D.Device, "heightmap01.bmp", "dirt03.dds", "colorm01.bmp"))
                    return false;
        ...
        private bool HandleInput(float frameTime)
        {
            ...
            MiniMap.PositionUpdate(Position.PositionX, Position.PositionZ);
