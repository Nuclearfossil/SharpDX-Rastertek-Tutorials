using DGameEngine.Tut35.System;
using SharpDX;
...
namespace DGameEngine.Tut35.Graphics.Shaders
{
    // Added In Tutorial 5
    // Modified in Tutorial 11 by adding .SetToZero() method on the struct 'DVertex'
    public class DTextureShader : ICloneable
    {
        // Structs
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                SamplerStateDescription samplerDesc = new SamplerStateDescription() 
                {
                    ...
                    #region EX 5: Experimenting with different Filter types for a different pixel interpolation on the surface.
