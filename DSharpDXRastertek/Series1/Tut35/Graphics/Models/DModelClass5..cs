...
namespace DSharpDXRastertek.Tut35.Graphics.Models
{
    public class DModel                 // 159 lines
    {
        // Structures
        ...
        // Methods
        public bool Initialize(SharpDX.Direct3D11.Device device, string modelFormatFilename)
        {
