using DSharpDXRastertek.Tut13.Graphics;
using DSharpDXRastertek.Tut13.Input;
using SharpDX.Windows;
using System.Drawing;
using System.Windows.Forms;
using TestConsole;

namespace DSharpDXRastertek.Tut13.System
{
    public class DSystem                    // 135 lines
    {
        ...
        public bool Frame()
        {
            ...
            if (!Graphics.Frame(mouseX, mouseY, Input.PressedKeyss))
                return false;
