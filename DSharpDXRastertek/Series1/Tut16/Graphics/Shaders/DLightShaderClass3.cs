...
namespace DSharpDXRastertek.Tut16.Graphics.Shaders
{
    public class DLightShader                   // 295 lines
    {
        // Structs
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector3 lightDirection,  Vector4 diffuseColor)  // Vector4 ambientColor,Vector4 specularColor, float specularPower, Vector3 cameraPosition
        {
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector3 lightDirection,  Vector4 diffuseColor) // Vector4 specularColor, float specularPower, Vector4 ambientColor,, Vector3 cameraPosition
        {
            try
            {
