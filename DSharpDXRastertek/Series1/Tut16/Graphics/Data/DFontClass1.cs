...
namespace DSharpDXRastertek.Tut16.Graphics.Data
{
    public class DFont                  // 180 lines
    {
        ...
        public void BuildVertexArray(out List<DLightShader.DVertexT> vertices, string sentence, float drawX, float drawY)
        {
            // Create list of the vertices
            vertices = new List<DLightShader.DVertexT>();
        ...
        private void BuildVertexArray(List<DLightShader.DVertexT> vertices, int letter, ref float drawX, ref float drawY)
        {
            // First triangle in the quad
            vertices.Add // Top left.
            (
                new DLightShader.DVertexT()
                {
