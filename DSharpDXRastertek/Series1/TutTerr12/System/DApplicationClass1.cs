using DSharpDXRastertek.TutTerr12.Graphics;
using DSharpDXRastertek.TutTerr12.Graphics.Camera;
using DSharpDXRastertek.TutTerr12.Graphics.Data;
using DSharpDXRastertek.TutTerr12.Graphics.Input;
using DSharpDXRastertek.TutTerr12.Graphics.Models;
using DSharpDXRastertek.TutTerr12.Graphics.Shaders;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.TutTerr12.System
{
    public class DApplication                   // 344 lines
    {
        // Properties
        ...
        public bool Frame(float frameTime)
        {
            ...
            SkyPlane.Frame(); // Timer.FrameTime
