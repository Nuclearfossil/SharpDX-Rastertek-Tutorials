...
namespace DSharpDXRastertek.Tut19.Graphics.Shaders
{
    public class DAlphaMapShader                    // 218 lines
    {
        // Struct
        ...
        public bool Initialize(Device device, IntPtr windowsHandler)
        {
            ...
            return InitializeShader(device, windowsHandler, "alphamap.vs", "alphamap.ps");
        }
