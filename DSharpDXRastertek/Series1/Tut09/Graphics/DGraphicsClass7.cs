...
namespace DSharpDXRastertek.Tut09.Graphics
{
    public class DGraphics                  // 147 lines
    {
        ...
        private bool Render(float rotation)
        {
            ...
            if (!LightShader.Render(D3D.DeviceContext, Model.IndexCount, worldMatrix, viewMatrix, projectionMatrix, Model.Texture.TextureResource, Light.Direction, Light.AmbientColor, Light.DiffuseColour))
                return false;
