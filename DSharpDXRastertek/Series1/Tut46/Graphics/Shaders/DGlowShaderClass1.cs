...
{
    public class DGlowShader                    // 269 lines
    {
        // Structs
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct DGlowBufferType
        {
        ...
        public SharpDX.Direct3D11.Buffer ConstantGlowBuffer { get; set; }
        ...
        public bool Initialize(Device device, IntPtr windowsHandler)
        {
            ...
            return InitializeShader(device, windowsHandler, "glow.vs", "glow.ps");
        }
        ...
        private void ShuddownShader()
        {
            ...
            ConstantGlowBuffer?.Dispose();
            ConstantGlowBuffer = null;
            // Release the layout.
            Layout?.Dispose();
            Layout = null;
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView colorTexture, ShaderResourceView glowTexture, float glowStrength)
        {
