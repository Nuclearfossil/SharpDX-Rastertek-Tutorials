...
namespace DSharpDXRastertek.Tut46.Graphics.Models
{
    public class DBitmap                    // 238 lines
    {
        ...
        public DTexture GlowMapTexture { get; private set; }
        ...
        {
            return Initialize(device, screeenWidth, screenHeight, textureFileName, glowMapFileName, bitmapWidth, bitmapHeight);
        }
        public bool Initialize(SharpDX.Direct3D11.Device device, int screeenWidth, int screenHeight, string textureFileName, string glowMapFileName, int bitmapWidth, int bitmapHeight)
        {
            ...
            if (!LoadTexture(device, textureFileName, glowMapFileName))
                return false;
