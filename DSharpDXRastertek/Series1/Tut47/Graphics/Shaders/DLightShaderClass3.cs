...
namespace DSharpDXRastertek.Tut47.Graphics.Shaders
{
    public class DLightShader                   // 281 lines
    {
        // Structs
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector3 lightDirection)
        {
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector3 lightDirection)
        {
            try
            {
                ...
                var lightBuffer = new DLightBuffer()
                {
