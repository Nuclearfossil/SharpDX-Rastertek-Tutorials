...
namespace DSharpDXRastertek.Tut47.Graphics.Models
{
    public class DTextClass                 // 273 lines
    {
        // Structs
        ...
        public DSentence[] sentences = new DSentence[1];
        ...
        private bool InitializeSentence(out DSentence sentence, int maxLength, SharpDX.Direct3D11.Device device)
        {
            ...
            var vertices = new DTextureShader.DVertex[sentence.VertexCount];
            ...
            var vertexBufferDesc = new BufferDescription()
            {
                ...
                SizeInBytes = Utilities.SizeOf<DTextureShader.DVertex>() * sentence.VertexCount,
        ...
        private bool UpdateSentece(ref DSentence sentence, string text, int positionX, int positionY, float red, float green, float blue, DeviceContext deviceContext)
        {
            ...
            List<DTextureShader.DVertex> vertices;
            ...
            mappedResource.WriteRange<DTextureShader.DVertex>(vertices.ToArray());
        ...
        internal void SetIntersection(bool Intersection, DeviceContext deviceContext)
        {
            if (Intersection)
                UpdateSentece(ref sentences[0], "Intersection: Yes", 20, 20, 0.0f, 1.0f, 0.0f, deviceContext);
            else
                UpdateSentece(ref sentences[0], "Intersection: No", 20, 20, 1.0f, 0.0f, 0.0f, deviceContext);
        }
    }
}