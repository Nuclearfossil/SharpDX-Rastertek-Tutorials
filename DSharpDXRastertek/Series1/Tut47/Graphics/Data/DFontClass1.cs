...
namespace DSharpDXRastertek.Tut47.Graphics.Data
{
    public class DFont                  // 180 lines
    {
        // Structs
        ...
        public void BuildVertexArray(out List<DTextureShader.DVertex> vertices, string sentence, float drawX, float drawY)
        {
            // Create list of the vertices
            vertices = new List<DTextureShader.DVertex>();
        ...
        private void BuildVertexArray(List<DTextureShader.DVertex> vertices, int letter, ref float drawX, ref float drawY)
        {
