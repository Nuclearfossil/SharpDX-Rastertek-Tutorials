using DSharpDXRastertek.TutTerr15.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr15.Graphics.Shaders
{
    public class DBumpMapShader                 // 300 lines
    {
        // Structs
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 diffuseColor, Vector3 lightDirection, ShaderResourceView colorTexture, ShaderResourceView normalMapTexture)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, diffuseColor, lightDirection, colorTexture, normalMapTexture))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 diffuseColor, Vector3 lightDirection, ShaderResourceView colorTexture, ShaderResourceView normalMapTexture)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResources(0, colorTexture, normalMapTexture);
                #endregion
