...
namespace DSharpDXRastertek.TutTerr15.Graphics.Models
{
    public class DTerrainHeightMap                  // 578 lines
    {
        // Structs
        ...
        // Methods.
        public bool Initialize(SharpDX.Direct3D11.Device device, string heightMapFileName, string colorTextureFilename, string normalMapFilename)
        {
            ...
            // Load the textures.
            if (!LoadTextures(device, colorTextureFilename, normalMapFilename))
                return false;
