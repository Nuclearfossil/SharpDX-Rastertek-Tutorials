...
namespace DSharpDXRastertek.Tut36.Graphics.Models
{
    public class DModel                 // 193 lines
    {
        // Structures
        ...
        public bool Initialize(SharpDX.Direct3D11.Device device, string modelFormatFilename, string textureFileName)
        {
            ...
            if (!LoadTextures(device, textureFileName))
                return false;
        ...
        private bool LoadTextures(SharpDX.Direct3D11.Device device, string textureFileName)
        {
        ...
        internal ShaderResourceView GetTexture()
        {
