using DSharpDXRastertek.TutTerr17.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr17.Graphics.Shaders
{
    public class DTerrainShader                 // 300 lines
    {
        // Structures
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector3 lightDirection, ShaderResourceView colorTexture1, ShaderResourceView colorTexture2, ShaderResourceView colorTexture3, ShaderResourceView colorTexture4, ShaderResourceView alphaTexture1, ShaderResourceView normalMap1, ShaderResourceView normalMap2)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, lightDirection, colorTexture1, colorTexture2, colorTexture3, colorTexture4, alphaTexture1, normalMap1, normalMap2))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector3 lightDirection, ShaderResourceView colorTexture1, ShaderResourceView colorTexture2, ShaderResourceView colorTexture3, ShaderResourceView colorTexture4, ShaderResourceView alphaTexture1, ShaderResourceView normalMap1, ShaderResourceView normalMap2)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResources(0, colorTexture1, colorTexture2, colorTexture3, colorTexture4, alphaTexture1, normalMap1, normalMap2);
