...
namespace DSharpDXRastertek.TutTerr17.Graphics.Models
{
    public class DTerrainHeightMap                  // 582 lines
    {
        // Structs
        ...
        // Methods.
        public bool Initialize(SharpDX.Direct3D11.Device device, string heightMapFileName, float maximumHeight)
        {
        ...
        private void BuildTerrainModel()
        {
            ...
            for (int j = 0; j < (m_TerrainHeight - 1); j++)
            {
                for (int i = 0; i < (m_TerrainWidth - 1); i++)
                {
                    ...
                    TerrainModel[index].tu2 = tu2Left;
                    TerrainModel[index].tv2 = tv2Top;
                    index++;
                    ...
                    TerrainModel[index].tv = 0.0f;
                    TerrainModel[index].tu2 = tu2Right;
                    TerrainModel[index].tv2 = tv2Top;
                    index++;
                    ...
                    TerrainModel[index].tu2 = tu2Left;
                    TerrainModel[index].tv2 = tv2Bottom;
                    index++;
        ...
        private bool InitializeBuffers(SharpDX.Direct3D11.Device device)
        {
            try
            {
                ...
                for (int i = 0; i < VertexCount; i++)
                {
                    ...
                    vertices[i].texture2 = new Vector2(TerrainModel[i].tu2, TerrainModel[i].tv2);
                    indices[i] = i;
                }
