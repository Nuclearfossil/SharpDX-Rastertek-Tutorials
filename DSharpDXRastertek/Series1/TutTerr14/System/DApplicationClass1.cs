using DSharpDXRastertek.TutTerr14.Graphics;
using DSharpDXRastertek.TutTerr14.Graphics.Camera;
using DSharpDXRastertek.TutTerr14.Graphics.Data;
using DSharpDXRastertek.TutTerr14.Graphics.Input;
using DSharpDXRastertek.TutTerr14.Graphics.Models;
using DSharpDXRastertek.TutTerr14.Graphics.Shaders;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.TutTerr14.System
{
    public class DApplication                   // 262 lines
    {
        // Properties
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
               ...
               // Initialize the terrain object.
                if (!TerrainModel.Initialize(D3D.Device, "heightmap.bmp", "grass.bmp", "slope.bmp", "rock.bmp"))
                    return false;
        ...
        private bool RenderGraphics()
        {
            ...
            if (!TerrainShader.Render(D3D.DeviceContext, TerrainModel.IndexCount, worldMatrix, cameraViewMatrix, projectionMatrix, Light.AmbientColor, Light.DiffuseColour, Light.Direction, TerrainModel.GrassTexture.TextureResource, TerrainModel.SlopeTexture.TextureResource, TerrainModel.RockTexture.TextureResource))
                return false;
