using DSharpDXRastertek.TutTerr14.System;
using SharpDX;
...
namespace DSharpDXRastertek.TutTerr14.Graphics.Shaders
{
    public class DTerrainShader                 // 274 lines
    {
        // Structures
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection, ShaderResourceView grassTexture, ShaderResourceView slopeTexture, ShaderResourceView rockTexture)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, ambientColour, diffuseColour, lightDirection, grassTexture, slopeTexture, rockTexture))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector4 ambientColour, Vector4 diffuseColour, Vector3 lightDirection, ShaderResourceView grassTexture, ShaderResourceView slopeTexture, ShaderResourceView rockTexture)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResources(0, grassTexture, slopeTexture, rockTexture);
