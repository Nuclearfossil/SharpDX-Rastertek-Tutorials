...
namespace DSharpDXRastertek.Tut43.Graphics.Shaders
{
    public class DProjectionShader                  // 290 lines
    {
        // Structs
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector4 ambientColor, Vector4 diffuseColor, Vector3 lightDirection, Matrix viewMatrix2, Matrix projectionMatrix2, ShaderResourceView projectionTexture)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, ambientColor, diffuseColor, lightDirection, viewMatrix2, projectionMatrix2, projectionTexture))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Vector4 ambientColor, Vector4 diffuseColor, Vector3 lightDirection, Matrix viewMatrix2, Matrix projectionMatrix2, ShaderResourceView projectionTexture)
        {
            try
            {
