...
{
    public class DSkyPlaneShader                    // 267 lines
    {
        // Structures
        ...
        {
            internal float firstTranslationX;
            internal float firstTranslationZ;
            internal float secondTranslationX;
            internal float secondTranslationZ;
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix,ShaderResourceView texture1, ShaderResourceView texture2, float firstTranslationX, float firstTranslationZ, float secondTranslationX, float secondTranslationZ, float brightness)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture1, texture2, firstTranslationX, firstTranslationZ, secondTranslationX, secondTranslationZ, brightness))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture1, ShaderResourceView texture2, float firstTranslationX, float firstTranslationZ, float secondTranslationX, float secondTranslationZ, float brightness)
        {
            try
            {
                ...
                {
                     firstTranslationX = firstTranslationX,
                     firstTranslationZ = firstTranslationZ,
                     secondTranslationX = secondTranslationX,
                     secondTranslationZ = secondTranslationZ,
                ...
                deviceContext.PixelShader.SetShaderResources(0, texture1, texture2);
