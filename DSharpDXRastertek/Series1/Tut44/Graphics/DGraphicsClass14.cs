using DSharpDXRastertek.Tut44.Graphics.Camera;
using DSharpDXRastertek.Tut44.Graphics.Data;
using DSharpDXRastertek.Tut44.Graphics.Models;
using DSharpDXRastertek.Tut44.Graphics.Shaders;
using DSharpDXRastertek.Tut44.System;
using SharpDX;
using System;
using System.Windows.Forms;

namespace DSharpDXRastertek.Tut44.Graphics
{
    public class DGraphics                  // 192 lines
    {
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            try
            {
                ...
                if (!ProjectionTexture.Initialize(D3D.Device, DSystemConfiguration.DataFilePath + "grate.dds"))
                    return false;
