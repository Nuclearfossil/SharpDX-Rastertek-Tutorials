...
namespace SharpDXWinForm
{
    public partial class SharpDXRastertekTutorialsForm : Form
    {
        ...
        private void buttonS2Tutorial5_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();
            ...
            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.Tut05.System.DSystem.StartRenderForm("Series 2 Tutorial 5: Texturing ", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);

            ToogleAllButtons();
        }
        private void buttonS2TerrainTutorial1_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();
        ...
        private void buttonS2TerrainTutorial3_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();
            ...
            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr03.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 3: Terrain Texturing", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);
        ...
        private void buttonS2TerrainTutorial5_Click(object sender, EventArgs e)
        {
            ...
            // Series 2 Terrain Tutorial 5: Color Mapped Terrain          -  3268 lines   - (C++:  287 FPS C#:  297 FPS)
            DSharpDXRastertek.Series2.TutTerr05.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 5: Color Mapped Terrain", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr05.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 5: Color Mapped Terrain", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);
        ...
        private void buttonS2TerrainTutorial7_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();

            // Series 2 Terrain Tutorial 7: Sky Domes          -  3268 lines   - (C++:  287 FPS C#:  297 FPS)
            DSharpDXRastertek.Series2.TutTerr07.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 7: Sky Domes", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr07.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 7: Sky Domes", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);
        ...
        private void buttonS2TerrainTutorial09_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();

            // Series 2 Terrain Tutorial 9: Terrain Cells         -  3268 lines   - (C++:  10 FPS C#:  14 FPS)
            DSharpDXRastertek.Series2.TutTerr09.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 9: Terrain Cells", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr09.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 9: Terrain Cells", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);

            ToogleAllButtons();
        }
        private void buttonS2TerrainTutorial10_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();

            // Series 2 Terrain Tutorial 10: Terrain Cell Culling         -  3268 lines   - (C++:  10 FPS C#:  14 FPS)
            DSharpDXRastertek.Series2.TutTerr10.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 10: Terrain Cell Culling", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr10.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 10: Terrain Cell Culling", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);

            ToogleAllButtons();
        }
        private void buttonS2TerrainTutorial11_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();

            // Series 2 Terrain Tutorial 11: Height Based Movement         -  3268 lines   - (C++:  10 FPS C#:  14 FPS)
            DSharpDXRastertek.Series2.TutTerr11.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 11: Height Based Movement", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr11.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 11: Height Based Movement", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);

            ToogleAllButtons();
        }
        private void buttonS2TerrainTutorial12_Click(object sender, EventArgs e)
        {
            ToogleAllButtons();

            // Series 2 Terrain Tutorial 12: Terrain Mini-Maps         -  3268 lines   - (C++:  10 FPS C#:  14 FPS)
            DSharpDXRastertek.Series2.TutTerr12.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 12: Terrain Mini-Maps", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, checkBoxScreenSize.Checked, (int)numericUpDownTimeInSeconds.Value);
            Thread.Sleep(3000);

            // Execute Second pass with the Full Screen off since it was first sent in Fullscreen.
            if (checkBoxScreenSize.CheckState == CheckState.Indeterminate)
                DSharpDXRastertek.Series2.TutTerr12.System.DSystem.StartRenderForm("Series 2 Terrain Tutorial 12: Terrain Mini-Maps", (int)numericUpDownWidth.Value, (int)numericUpDownHeight.Value, checkBoxVSync.Checked, false, (int)numericUpDownTimeInSeconds.Value);
