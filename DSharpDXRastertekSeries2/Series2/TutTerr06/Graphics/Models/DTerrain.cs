    ...
    public class DTerrain
    {
        ...
        private bool InitializeBuffers(SharpDX.Direct3D11.Device device)
        {
            try
            {
                ...
                //        {
                //            position = new Vector3(TerrainModel[indexUpperLeft3].x, TerrainModel[indexUpperLeft3].y, TerrainModel[indexUpperLeft3].z),
                //            texture = new Vector2(0.0f, 0.0f),
                //            normal = new Vector3(TerrainModel[indexUpperLeft3].nx, TerrainModel[indexUpperLeft3].ny, TerrainModel[indexUpperLeft3].nz),
                //            tangent = new Vector3(TerrainModel[indexUpperLeft3].tx, TerrainModel[indexUpperLeft3].ty, TerrainModel[indexUpperLeft3].tz),
                //            binormal = new Vector3(TerrainModel[indexUpperLeft3].bx, TerrainModel[indexUpperLeft3].by, TerrainModel[indexUpperLeft3].bz),
                //            color = new Vector3(TerrainModel[indexUpperLeft3].r, TerrainModel[indexUpperLeft3].g, TerrainModel[indexUpperLeft3].b)
                //        };
                //        indices[index] = index++;
                //        // Upper right.
                //        vertices[index] = new DVertexType()
                //        {
                //            position = new Vector3(TerrainModel[indexUpperRight4].x, TerrainModel[indexUpperRight4].y, TerrainModel[indexUpperRight4].z),
                //            texture = new Vector2(1.0f, 0.0f),
                //            normal = new Vector3(TerrainModel[indexUpperRight4].nx, TerrainModel[indexUpperRight4].ny, TerrainModel[indexUpperRight4].nz),
                //            tangent = new Vector3(TerrainModel[indexUpperRight4].tx, TerrainModel[indexUpperRight4].ty, TerrainModel[indexUpperRight4].tz),
                //            binormal = new Vector3(TerrainModel[indexUpperRight4].bx, TerrainModel[indexUpperRight4].by, TerrainModel[indexUpperRight4].bz),
                //            color = new Vector3(TerrainModel[indexUpperRight4].r, TerrainModel[indexUpperRight4].g, TerrainModel[indexUpperRight4].b)
                //        };
                //        indices[index] = index++;
                //        // Bottom left.
                //        vertices[index] = new DVertexType()
                //        {
                //            position = new Vector3(TerrainModel[indexBottomLeft1].x, TerrainModel[indexBottomLeft1].y, TerrainModel[indexBottomLeft1].z),
                //            texture = new Vector2(0.0f, 1.0f),
                //            normal = new Vector3(TerrainModel[indexBottomLeft1].nx, TerrainModel[indexBottomLeft1].ny, TerrainModel[indexBottomLeft1].nz),
                //            tangent = new Vector3(TerrainModel[indexBottomLeft1].tx, TerrainModel[indexBottomLeft1].ty, TerrainModel[indexBottomLeft1].tz),
                //            binormal = new Vector3(TerrainModel[indexBottomLeft1].bx, TerrainModel[indexBottomLeft1].by, TerrainModel[indexBottomLeft1].bz),
                //            color = new Vector3(TerrainModel[indexBottomLeft1].r, TerrainModel[indexBottomLeft1].g, TerrainModel[indexBottomLeft1].b)
                //        };
                //        indices[index] = index++;
                //        #endregion
                ...
                //        vertices[index] = new DVertexType()
                //        {
                //            position = new Vector3(TerrainModel[indexBottomRight2].x, TerrainModel[indexBottomRight2].y, TerrainModel[indexBottomRight2].z),
                //            texture = new Vector2(1.0f, 1.0f),
                //            normal = new Vector3(TerrainModel[indexBottomRight2].nx, TerrainModel[indexBottomRight2].ny, TerrainModel[indexBottomRight2].nz),
                //            tangent = new Vector3(TerrainModel[indexBottomRight2].tx, TerrainModel[indexBottomRight2].ty, TerrainModel[indexBottomRight2].tz),
                //            binormal = new Vector3(TerrainModel[indexBottomRight2].bx, TerrainModel[indexBottomRight2].by, TerrainModel[indexBottomRight2].bz),
                //            color = new Vector3(TerrainModel[indexBottomRight2].r, TerrainModel[indexBottomRight2].g, TerrainModel[indexBottomRight2].b)
                //        };
                //        indices[index] = index++;
                //        #endregion
                //    }
