using DSharpDXRastertek.Series2.TutTerr14.Graphics;
...
namespace DSharpDXRastertek.Series2.TutTerr14.System
{
    public class DApplication
    {
        ...
        public bool Initialize(DSystemConfiguration configuration, IntPtr windowHandle)
        {
            ...
            if (!TextureManager.LoadTexture(D3D.Device, D3D.DeviceContext, "snow01n.bmp", 2))
                return false;
            if (!TextureManager.LoadTexture(D3D.Device, D3D.DeviceContext, "distance01n.bmp", 3))
                return false;
