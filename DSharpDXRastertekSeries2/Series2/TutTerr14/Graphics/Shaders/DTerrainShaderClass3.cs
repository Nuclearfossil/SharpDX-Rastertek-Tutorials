using DSharpDXRastertek.Series2.TutTerr14.System;
using SharpDX;
...
namespace DSharpDXRastertek.Series2.TutTerr14.Graphics.Shaders
{
    public class DTerrainShader                   // 332 lines
    {
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, ShaderResourceView normal, ShaderResourceView normal1, ShaderResourceView normal2, Vector3 lightDirection, Vector4 diffuse)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, normal, normal1, normal2, lightDirection, diffuse))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, ShaderResourceView normal, ShaderResourceView normal1, ShaderResourceView normal2, Vector3 lightDirection, Vector4 diffuse)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResources(2, normal1);
                deviceContext.PixelShader.SetShaderResources(3, normal2);
                #endregion
