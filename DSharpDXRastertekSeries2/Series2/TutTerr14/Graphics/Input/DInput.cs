...
namespace DSharpDXRastertek.Series2.TutTerr14.Graphics.Input
{
    public class DInput
    {
        // Variables.
        ...
        public bool IsF1Toogled()
        {
            return _KeyboardState != null && _KeyboardState.PressedKeys.Contains(Key.F1);
        }
        internal bool IsF2Toogled()
        {
            return _KeyboardState != null && _KeyboardState.PressedKeys.Contains(Key.F2);
        }
        internal bool isF3Toggled()
        {
            return _KeyboardState != null && _KeyboardState.PressedKeys.Contains(Key.F3);
        }
        internal bool isF4Toggled()
        {
            return _KeyboardState != null && _KeyboardState.PressedKeys.Contains(Key.F4);
        }
    }
}
