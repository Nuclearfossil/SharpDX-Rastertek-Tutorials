...
namespace DSharpDXRastertek.Series2.TutTerr13.Graphics.Shaders
{
    public class DTerrainShader                   // 332 lines
    {
        ...
        public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, ShaderResourceView normal, ShaderResourceView normal1, Vector3 lightDirection, Vector4 diffuse)
        {
            // Set the shader parameters that it will use for rendering.
            if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, normal, normal1, lightDirection, diffuse))
                return false;
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, ShaderResourceView normal, ShaderResourceView normal1, Vector3 lightDirection, Vector4 diffuse)
        {
            try
            {
